...
@RestController
@RequestMapping(value="/produtos") //o parametro do 'value' eh o nome do endpoit que eu quero criar, essa classe serah um controlador REST e
										// responderah pelo endpoint /categorias
public class ProdutoResource {
	
	@Autowired
	private ProdutoService service;		//acessando o servico
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		Page<ProdutoDTO> listDto = list.map(obj -> new ProdutoDTO(obj));	//'obj -> new' = operador de funcao anonima
