...
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		List<ClienteDTO> listDto = list.stream().map(obj -> new ClienteDTO(obj)).collect(Collectors.toList());	//'obj -> new' = operador de funcao anonima
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<ClienteDTO> listDto = list.map(obj -> new ClienteDTO(obj));	//'obj -> new' = operador de funcao anonima
		return ResponseEntity.ok().body(listDto);
	}
}
